            ...
            Keys = new ObservableCollection<OnScreenKey>
                       {
                           ...
                           new OnScreenKey { GridRow = 0, GridColumn = 1, Key = new VirtualKey(VirtualKeyCode.VK_8, IconDictionary.Icons["arrow-right-circle"], "") },
                           new OnScreenKey { GridRow = 0, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.VK_9, IconDictionary.Icons["minus-circle"], "") },
                           new OnScreenKey { GridRow = 1, GridColumn = 0, Key = new VirtualKey(VirtualKeyCode.VK_4, IconDictionary.Icons["plus-circle"], "") },
                           new OnScreenKey { GridRow = 1, GridColumn = 1, Key = new VirtualKey(VirtualKeyCode.VK_5, IconDictionary.Icons["delete"], "") },
                           new OnScreenKey { GridRow = 1, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.VK_6, IconDictionary.Icons["trash-2"], "") },
