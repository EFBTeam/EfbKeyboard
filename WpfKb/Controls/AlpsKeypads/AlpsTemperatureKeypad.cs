...
{
    public class AlpsTemperatureKeypad : UniformOnScreenKeyboard
    {
        public AlpsTemperatureKeypad()
        {
            Keys = new ObservableCollection<OnScreenKey>
                       {
                           ...
                           new OnScreenKey { GridRow = 3, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.OEM_MINUS, "-") },
