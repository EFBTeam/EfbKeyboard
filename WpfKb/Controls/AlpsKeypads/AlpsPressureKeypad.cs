...
{
    public class AlpsPressureKeypad : UniformOnScreenKeyboard
    {
        public AlpsPressureKeypad()
        {
            Keys = new ObservableCollection<OnScreenKey>
                       {
                           ...
                           new OnScreenKey { GridRow = 3, GridColumn = 2, Key = new VirtualKey(VirtualKeyCode.OEM_PERIOD, ".") },
